...
export default function Contact() {
    return (
      ...
      <div id="Contact" style={{fontFamily: "calibri",color: "#fff", background: 'rgb(2,0,36)',background: 'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(153,10,121,1) 40%, rgba(0,212,255,1) 100%)',paddingTop:'80px', fontSize: "40px", textAlign: 'center', fontWeight: '700', height: '100vh'}}>
        ...
        <div>
        <Grid container spacing={3} style={{marginTop: '10px',marginLeft: '-150px'}}>
            <Grid item lg={6} >
              <Paper style={{marginLeft: '281px'}}>
                <Box>
                  <iframe style={{height: '400px', width: '1495px'}}
          ...
          <Grid class="txt" item lg={6} >
            <Paper style={{marginRight: '490px',marginLeft: '450px',marginTop: '12px'}}>
              <Box p={9} >
                <TextField
